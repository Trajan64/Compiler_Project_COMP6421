...
The different possible arguments are: 
	...
	-run <source program> <derivation output file> <symbol output file> <error output file> <code output file> <token output file>
		...
		Example: -run ./test/programs/codegen_recursion.txt ./results/codegen_recursion_derivations.txt ./results/codegen_recursion_symboltable ./results/codegen_recursion_errors.txt ./results/codegen_recursion_code.m ./results/professor_sample_tokens.txt
	-test
